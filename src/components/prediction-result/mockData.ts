...
According to research [5], the energy consumption of this product's manufacturing is about 15% lower than the industry average, mainly due to high automation level and process optimization. Research [6] shows that PERC technology combined with multi-busbar technology can improve cell efficiency by 1.5-2.0%.
  ...
  comparativeAnalysis: {
    ...
    competitorsComparison: {
      ...
      competitorData: [
        { name: bilingual("本产品", "This Product"), value: 42.8, unit: "kg CO₂e/件", highlight: true, error: 6.4 },
        { name: bilingual("竞品A - NS-310", "Competitor A - NS-310"), value: 47.5, unit: "kg CO₂e/件", difference: "+11.0%", error: 7.1 },
        { name: bilingual("竞品B - HE-305", "Competitor B - HE-305"), value: 51.2, unit: "kg CO₂e/件", difference: "+19.6%", error: 7.7 },
        { name: bilingual("竞品C - BF-290", "Competitor C - BF-290"), value: 49.8, unit: "kg CO₂e/件", difference: "+16.4%", error: 7.5 },
    ...
    chartData: [
      ...
      { name: bilingual("竞品B", "Competitor B"), value: 51.2, error: 7.7, itemType: 'competitor' },
      { name: bilingual("竞品C", "Competitor C"), value: 49.8, error: 7.5, itemType: 'competitor' },
      { name: bilingual("竞品D", "Competitor D"), value: 39.5, error: 5.9, itemType: 'competitor' },
      { name: bilingual("行业基准", "Industry Benchmark"), value: 65.2, error: 6.5, itemType: 'industry' }
    ]
  }
};
