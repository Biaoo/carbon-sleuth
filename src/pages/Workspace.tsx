...
const Workspace = () => {
  ...
  // Main tab state
  const [mainTab, setMainTab] = useState('inference');
  
  // Inference sub-tab state
  ...
  // Handle cancelling a prediction
  const handleCancel = () => {
    if (isLoading) {
      setIsLoading(false);
      setProgress(0);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* LCA Inference Content */}
        <TabsContent value="inference" className="m-0 p-0">
        ...
        <TabsContent value="data-request" className="m-0">
          <div className="p-6">
